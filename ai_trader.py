        ...
        response = deepseek_client.chat.completions.create(
            ...
            messages=[
                ...
                **重要**：价格波动是市场自然行为，不构成平仓理由。只有趋势反转才是有效平仓信号。
                ...
                每次平仓后必须评估：
                1. 持仓时间是否足够
                2. 是否因真正的趋势反转而退出，而非暂时波动
                3. 是否遵循了原始交易计划和止盈/止损设置

                系统将根据质量评估自动调整未来交易行为，确保策略一致性。
